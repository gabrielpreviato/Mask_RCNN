...
class SsndaDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, class_ids=None,
                  class_map=None, return_ssnda=False, auto_download=False):
        ...
        # Add classes.
        self.add_class("ssdna", 1, "goal")
        self.add_class("ssdna", 2, "ball")
        self.add_class("ssdna", 3, "robot_team")
        self.add_class("ssdna", 4, "robot_opponent")
        ...
        # Add images
        images_path = sorted(glob.glob(os.path.join(dataset_dir, subset, 'rgb', '*' + '.png')))
